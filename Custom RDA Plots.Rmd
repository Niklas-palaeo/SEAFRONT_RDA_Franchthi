...
corr_matrix_fauna <- cbind(Filtered_D18O_Fauna,Filtered_Fauna)
...
climate_params <- c("range", "se", "Winter_Temp", "Summer_Temp")

corrplot(
  cor(corr_matrix_fauna)[animals,climate_params],
  # cor(corr_matrix_fauna)[5:22,1:4],
  method = "ellipse",
  tl.srt = 45 ,
